...
class Main:
    ...
    def create_setup(self):
        self.reset_all_settings()
        print('This option lets you set the settings for the Monster!')
        ...
        monster_move_count_choice = input('How many moves the should the monster get, for each of your moves (Default: 2): ')
        try:
